    ...
    <nav className="sticky top-0 z-50 bg-white border-b border-industrial-black/10">
      <div className="max-w-screen-2xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button className="bg-bfi-red text-white px-6 py-2 font-bold text-xs uppercase tracking-widest hover:bg-industrial-black transition-colors">
            Get a Quote
          </button>
        </div>
      ...
      {isOpen && (
        ...
        >
          ...
          <button className="bg-bfi-red text-white px-6 py-4 font-bold text-sm uppercase tracking-widest">
            Get a Quote
          </button>
        </motion.div>
      )}
