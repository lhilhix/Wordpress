...
async function seed() {
  ...
  const staticProducts = [
    { 
      ...
      isFeatured: true, 
      detailedDescription: "Produzidas com alta precisão e baixo atrito.", 
      specifications: "Material: POM\nTolerância: +-0.01mm\nTemperatura: -40°C a 120°C" 
    },
    { 
      id: "PB-002", 
      name: "Caixa Estéril", 
      ...
      isFeatured: true, 
      detailedDescription: "Esterilizável e resistente ao calor.", 
      specifications: "Material: PC Médico\nEsterilização: Autoclave\nTemp. Operação: Máx 135°C" 
    },
    { 
      id: "PB-003", 
      ...
      isFeatured: false, 
      detailedDescription: "Resistentes a altas temperaturas e vibrações.", 
      specifications: "Material: PA66\nRetardante: V-0\nTemp. Operação: -40°C a 150°C" 
    },
